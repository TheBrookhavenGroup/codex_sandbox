...
OpenAI Codex is an amazing tool useful beyond just having a ChatGBT style conversation.
...
The script will prompt the user to open sandbox shell and if so prompts to start codex.
